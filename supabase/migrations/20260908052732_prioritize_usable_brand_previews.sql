    ...
    select
      ...
      row_number() over (
        ...
        order by
          ...
          case
            when coalesce(nullif(a.thumbnail_url, ''), nullif(a.flattened_url, ''), nullif(a.image_url, '')) is not null
             and coalesce(a.thumbnail_url, a.flattened_url, a.image_url) not like 'data:image/%' then 0
